...
public class Practice3 {
    ...
    public static void main(String[] args) {
        ...
        // Root node
        System.out.println("Root: " + bt.head.data); //A


        // B's child node
        Node2 B = bt.searchNode('B');
        if (B.left != null) {
            System.out.println("B -> left child: " + B.left.data); //D
        }
        if (B.right != null) {
            System.out.println("B -> right child: " + B.right.data); //E
        }
        ...
        System.out.println("E depth: " + cnt); //2
        ...
        System.out.println("Height : "+maxCnt); //3

        // B's Size
        int size = bt.checkSize('B');
        System.out.println("B size = " + size); //6
